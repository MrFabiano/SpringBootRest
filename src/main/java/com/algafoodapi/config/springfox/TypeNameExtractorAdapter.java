package com.algafoodapi.config.springfox;
...
public class TypeNameExtractorAdapter extends TypeNameExtractor {
    ...
    public TypeNameExtractorAdapter(TypeResolver typeResolver,
                                    PluginRegistry<TypeNameProviderPlugin, DocumentationType> typeNameProviders, EnumTypeDeterminer enumTypeDeterminer) {
